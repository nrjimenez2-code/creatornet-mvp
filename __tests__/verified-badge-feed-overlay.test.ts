...
describe("VideoCard shows the Verified creator badge on the feed overlay", () => {
  ...
  test("main phone feed places each post's details and actions at the card bottom", async () => {
    ...
    expect(buy.parentElement!.className).toContain("max-lg:order-1");
    expect(name.parentElement!.className).toContain("max-lg:order-2");
    expect(buy.parentElement!.className).toContain("lg:-translate-y-[0.67in]");
    expect(name.className).toContain("lg:font-bold");
    ...
    expect(caption.className).toContain("lg:text-[15px]");
    expect(caption.className).toContain("lg:font-normal");
    ...
    expect(tag.parentElement!.parentElement!.className).toContain("lg:text-[15px]");
    expect(tag.parentElement!.parentElement!.className).toContain("lg:font-semibold");
