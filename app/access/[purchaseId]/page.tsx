...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-svh bg-white text-gray-900 p-8">
  ...
  if (!user) {
    return (
      <Shell>
        ...
        <p className="text-gray-600">Please sign in to view your purchase access.</p>
    ...
    <Shell>
      ...
      <div className="rounded-2xl border border-gray-200 p-5 space-y-4">
        <div className="text-sm text-gray-500">
          Status:{" "}
          <span className="font-medium text-gray-800">{p.status ?? "paid"}</span>
        ...
        {p.fulfillment_url ? (
          <>
            ...
            <div className="font-medium mb-2">{p.fulfillment ?? "link"}</div>
            ...
            <div className="mt-3 flex gap-3">
              <CopyLinkButton url={p.fulfillment_url} />
          ...
          <>
            ...
            <p className="text-gray-700">
              We’re finalizing your access. This usually appears right after the
